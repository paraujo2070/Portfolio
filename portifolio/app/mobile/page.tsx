...
export default function mobile() {
  return (
    ...
    <div className="leading-normal tracking-normal bg-gray-50 text-gray-800 min-h-screen">

      <section className="py-16">
       
        <div className="w-full px-4">
            <h1 className="text-3xl sm:text-4xl font-bold text-center mb-8">Sistema Especialista para Planejamento Financeiro</h1>

           
            <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-md p-4 sm:p-6 md:p-8 mb-8">
